...
window.POINTS_CONFIG = {
  ...
  avant_projet: {
    ...
    // --- RDC (Rez-de-Chaussee) ---
    rdc: [
      { scene: 'extérieur',      image: 'photo/prieuré/edl/360/extérieur.webp',      top: '80%', left: '41%' },
      { scene: 'extérieur2',     image: 'photo/prieuré/edl/360/extérieur2.webp',     top: '60%', left: '7%'  },
      { scene: 'salleréunion',   image: 'photo/prieuré/edl/360/salleréunion.webp',   top: '40%', left: '28%' },
      { scene: 'salleréunion2',  image: 'photo/prieuré/edl/360/salleréunion2.webp',  top: '60%', left: '25%' },
      { scene: 'cuisine',        image: 'photo/prieuré/edl/360/cuisine.webp',        top: '58%', left: '43%' },
      { scene: 'wc',             image: 'photo/prieuré/edl/360/wc.webp',             top: '43%', left: '40%' },
      { scene: 'salleréception', image: 'photo/prieuré/edl/360/sallereception.webp', top: '52%', left: '58%' },
    ],

    // --- R+1 (1er etage) ---
    r1: [
      { scene: 'billard',       image: 'photo/prieuré/edl/360/billard.webp',      top: '62%', left: '50%' },
      { scene: 'grandesalle',   image: 'photo/prieuré/edl/360/grandesalle.webp',  top: '50%', left: '60%' },
      { scene: 'petitesalle',   image: 'photo/prieuré/edl/360/petitesalle.webp',  top: '58%', left: '41%' },
      { scene: 'toilette',      image: 'photo/prieuré/edl/360/toilette.webp',     top: '41%', left: '41%' },
      { scene: 'mezzanine',     image: 'photo/prieuré/edl/360/mezzanine.webp',    top: '40%', left: '24%' },
    ],

    // --- RDJ (Rez-de-Jardin) ---
    rdj: [
      { scene: 'samplesroom',   image: 'photo/prieuré/edl/360/samplesroom.webp', top: '50%', left: '60%', action: 'samplesroom' },
      { scene: 'yoga',          image: 'photo/prieuré/edl/360/yoga.webp',        top: '50%', left: '28%' },
      { scene: 'extérieur3',    image: 'photo/prieuré/edl/360/extérieur3.webp',  top: '30%', left: '70%' },
    ],
  },
  ...
  projet_airhub: {
    ...
    // --- RDC (Rez-de-Chaussee) ---
    rdc: [
      { scene: 'extérieur_p',      image: 'photo/prieuré/projet/360/extérieur_p.png',      top: '80%', left: '41%' },
      { scene: 'extérieur2_p',     image: 'photo/prieuré/projet/360/extérieur2_p.png',     top: '60%', left: '7%'  },
      { scene: 'boutique_p',       image: 'photo/prieuré/projet/360/boutique_p.png',       top: '40%', left: '28%' },
      { scene: 'boutique2_p',      image: 'photo/prieuré/projet/360/boutique2_p.png',      top: '60%', left: '25%' },
      { scene: 'atelier_p',        image: 'photo/prieuré/projet/360/atelier_p.png',        top: '58%', left: '43%' },
      { scene: 'toilette_p',       image: 'photo/prieuré/projet/360/toilette_p.png',       top: '43%', left: '40%' },
      { scene: 'cuisine_p',        image: 'photo/prieuré/projet/360/cuisine_p.png',        top: '52%', left: '58%' },
    ],

    // --- R+1 (1er etage) ---
    r1: [
      { scene: 'billard_vide_p',          image: 'photo/prieuré/projet/360/billard_vide_p.png',          top: '62%', left: '50%' },
      { scene: 'grandesalle_vide_p',      image: 'photo/prieuré/projet/360/grandesalle_vide_p.png',      top: '50%', left: '60%' },
      { scene: 'petitesalle_vide_p',      image: 'photo/prieuré/projet/360/petitesalle_vide_p.png',      top: '58%', left: '41%' },
      { scene: 'toilette_vide_p',         image: 'photo/prieuré/projet/360/toilette_vide_p.png',         top: '41%', left: '41%' },
      { scene: 'test_p',                  image: 'photo/prieuré/projet/360/test_p.png',                  top: '40%', left: '24%' },
    ],

    // --- RDJ (Rez-de-Jardin) ---
    rdj: [
      { scene: 'formation_p',      image: 'photo/prieuré/projet/360/samplesroom_p.png',   top: '50%', left: '60%' },
      { scene: 'formation2_p',     image: 'photo/prieuré/projet/360/yoga_p.png',          top: '50%', left: '28%' },
      { scene: 'extérieur3_p',     image: 'photo/prieuré/projet/360/extérieur3_p.png',    top: '30%', left: '70%' },
    ],
  },
